...
The container's configuration resides in the [Arquillian XML](https://github.com/tolis-e/aerogear-controller-demo-test/blob/master/src/test/resources/arquillian.xml) configuration file while the deployment and the archive are defined in the [Deployments](https://github.com/tolis-e/aerogear-controller-demo-test/blob/master/src/test/java/org/jboss/aerogear/controller/demo/test/Deployments.java) file.
...
The [POM](https://github.com/tolis-e/aerogear-controller-demo-test/blob/master/pom.xml) file contains two profiles:
